...
/// <param name="OccurredOn">The datetime on which the event occourred.</param>
public record PersistedEvent<TId>(Guid Id, TId StreamId, int Version, string EventName, byte[] Payload, DateTimeOffset OccurredOn);
